...
gulp.task("copy-index",function(){
	gulp.src("*.html")
	.pipe(gulp.dest("D:\\phpStudy\\WWW\\pandaread"));
});

// gulp.task("copy-phpwork",function(){
// 	gulp.src("php/*.php")
// 	.pipe(gulp.dest("D:\\phpStudy\\WWW\\pandaread\\php"));
// });
...
gulp.task("jstext",function(){
	gulp.src("js/*.js")
		.pipe(gulp.dest("D:\\phpStudy\\WWW\\pandaread\\js"));
});
...
gulp.task("sassfile",function(){
	gulp.src("css/*.css")
		.pipe(gulp.dest("D:\\phpStudy\\WWW\\pandaread\\css"));
});
...
gulp.task("copy-img",function(){
	gulp.src("img/**/*")
	.pipe(gulp.dest("D:\\phpStudy\\WWW\\pandaread\\img"));
});
